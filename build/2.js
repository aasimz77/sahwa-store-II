...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__bp_messages__ = __webpack_require__(435);
...
var BpMessagesModule = /** @class */ (function () {
    ...
    BpMessagesModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__bp_messages__["a" /* BpMessages */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_globalvars_globalvars__ = __webpack_require__(30);
...
var BpMessages = /** @class */ (function () {
    function BpMessages(nav, navParams, globalvars, loadingController, storage, toastCtrl, viewCtrl, platform, headerLogoService, Network, Device, actionSheet, camera, modalCtrl, events, ga, bpProvider, translate, renderer, elementRef) {
        var _this = this;
        this.nav = nav;
    ...
    BpMessages.prototype.ionSelected = function () {
        ...
        this.events.subscribe('bp-add-message', function (data) {
            if (_this.singleThread) {
                if (!_this.threads || !_this.threads.messages) {
                    _this.getThreads(_this.base_route + '/' + data.threadId);
                }
                else {
    ...
    BpMessages.prototype.setupSegments = function () {
        var translateInbox = this.translate.instant('Inbox');
        var translateSent = this.translate.instant('Sent');
    ...
    /**
     * This pushes the message text to the thread, then sends it to the server.
     ...
     */
    BpMessages.prototype.sendImage = function () {
        var _this = this;
        var options = {
        ...
        this.actionSheet.show(options).then(function (buttonIndex) {
            if (buttonIndex === 1) {
                _this.bpProvider.doCamera('camera')
                    ...
                    _this._replyToThreadWithImage(uploadedImage);
                })
     ...
     */
    BpMessages.prototype._replyToThreadWithImage = function (imageMessage) {
        var _this = this;
        // 1) Reply to thread if text exists
        if (this.threadReply) {
            this.replyToThread();
        ...
        // 2) Show image in thread
        var imageTag = '<img src="' + imageMessage + '">';
