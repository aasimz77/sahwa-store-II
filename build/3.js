...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__bp_list__ = __webpack_require__(434);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pipes_do_links_do_links_module__ = __webpack_require__(416);
...
var BpListModule = /** @class */ (function () {
    ...
    BpListModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__bp_list__["a" /* BpList */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_globalvars_globalvars__ = __webpack_require__(30);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_network__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_buddypress_bp_provider__ = __webpack_require__(276);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_analytics_analytics_service__ = __webpack_require__(56);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BpList = /** @class */ (function () {
    ...
    BpList.prototype.ionSelected = function () {
    ...
    BpList.prototype.setupSegments = function () {
        ...
        var translateAll = 'All'; // this.translate.instant('All');
        var translateMyGroups = 'My Groups'; // this.translate.instant('My Groups');
        var translateFriends = 'Friends'; // this.translate.instant('Friends');
        var translateMentions = 'Mentions'; // this.translate.instant('Mentions');
        var translateMe = 'Me'; // this.translate.instant('Me');
    ...
    BpList.prototype.addParams = function (route) {
        ...
        var getSegmentArg = this.getSegmentArg();
        if (getSegmentArg !== '') {
    ...
    BpList.prototype.favorite = function (item) {
        ...
        this.bpProvider.updateItem('activity_favorite', this.login_data, item.id).then(function (ret) {
            if (!ret) {
                ...
                _this.translate.get('Cannot favorite this item.').subscribe(function (text) {
                    _this.presentToast(text);
                });
            }
        }).catch(function (e) {
            _this.translate.get('There was a problem favoriting this item.').subscribe(function (text) {
                _this.presentToast(text);
            });
            _this.undoFavCount(item);
            console.warn(e);
    ...
    BpList.prototype.loginCheck = function () {
        ...
        if (!this.login_data || !this.login_data.user_id) {
            this.translate.get('Please log in or sign up.').subscribe(function (text) {
                _this.presentToast(text);
            });
