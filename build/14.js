...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__media_list__ = __webpack_require__(460);
...
var MediaListModule = /** @class */ (function () {
    ...
    MediaListModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__media_list__["a" /* MediaList */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_posts_posts__ = __webpack_require__(277);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_globalvars_globalvars__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_header_logo_header_logo__ = __webpack_require__(141);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_network__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_download_download__ = __webpack_require__(149);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_file__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ngx_translate_core__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_streaming_media_streaming_media__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_pdf_pdf__ = __webpack_require__(142);
...
var MediaList = /** @class */ (function () {
    function MediaList(nav, navParams, postService, globalvars, loadingController, storage, toastCtrl, viewCtrl, platform, headerLogoService, Network, Device, download, modalCtrl, file, translate, events, zone, streamingMediaPlayer, ga, pdfService) {
        var _this = this;
        this.nav = nav;
        ...
        this.storage.get('media-list-autoplay').then(function (value) {
            _this.doAutoPlay = (value === false) ? false : true;
        });
    ...
    MediaList.prototype.getPosts = function () {
    ...
    MediaList.prototype.ionSelected = function () {
        this.getPosts();
    };
    ...
    MediaList.prototype.loadPosts = function (route) {
        ...
        this.postService.load(route, this.page).then(function (items) {
            ...
            if (!_this.items.length) {
                _this.translate.get('No media urls are defined.').subscribe(function (text) {
                    _this.presentToast(text);
                });
        ...
        if (inArray === false) {
            ...
            this.download.downloadFile(item.appp_media.media_url).then(function (downloadUrl) {
                ...
                if (downloadUrl) {
                    ...
                    _this.translate.get('Downloaded!').subscribe(function (text) {
                        _this.presentToast(text);
                    });
                }
                else {
                    _this.translate.get('Problem downloading file.').subscribe(function (text) {
                        _this.presentToast(text);
                    });
                }
            })
    ...
    MediaList.prototype.playStreamingMedia = function (item) {
        var url = '';
        ...
        var data = { source: url, title: title };
        var playlist = this.getMediaSources();
        if (item.appp_media.media_image) {
            data.image = item.appp_media.media_image;
        }
        this.ga.trackScreenView('MediaPlayer', 'play/' + data.title);
        this.streamingMediaPlayer.start(data, playlist);
    };
    MediaList.prototype.handlePDF = function (src) {
        this.pdfService.openPdf(src);
    };
    MediaList.prototype.getMediaSources = function () {
        var sources = [];
        var mediaUrl = '';
        var mediaImage = '';
        for (var i = 0; i < this.items.length; i++) {
    ...
    MediaList = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0_ionic_angular__["m" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_11__providers_streaming_media_streaming_media__["a" /* StreamingMediaPlayer */],
            __WEBPACK_IMPORTED_MODULE_13__providers_analytics_analytics_service__["a" /* AnalyticsService */],
            __WEBPACK_IMPORTED_MODULE_12__providers_pdf_pdf__["a" /* PdfService */]])
    ], MediaList);
    return MediaList;
}());
