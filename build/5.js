...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__post_list__ = __webpack_require__(463);
...
var PostListModule = /** @class */ (function () {
    ...
    PostListModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__post_list__["a" /* PostList */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_analytics_analytics_service__ = __webpack_require__(56);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PostList = /** @class */ (function () {
    ...
    PostList.prototype.loadPosts = function (route) {
        ...
        // If doing search, don't show the loader because it will cause the search input to lose focus, then hides the keyboard
        if (!this.showSearch) {
    ...
    PostList.prototype.ionSelected = function () {
        this.loadPosts(this.route);
    };
