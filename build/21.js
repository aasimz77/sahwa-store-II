...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__bp_modal__ = __webpack_require__(438);
...
var BpModalModule = /** @class */ (function () {
    ...
    BpModalModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__bp_modal__["a" /* BpModal */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_buddypress_bp_provider__ = __webpack_require__(276);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_action_sheet__ = __webpack_require__(75);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BpModal = /** @class */ (function () {
    function BpModal(navParams, viewCtrl, loadingCtrl, events, storage, translate, toastCtrl, Device, bpProvider, actionSheet, modalCtrl, platform) {
        ...
        this.storage.get('user_login').then(function (data) {
            if (data && data.user_id) {
                ...
                _this.translate.get('Please logout then log back in.').subscribe(function (text) {
    ...
    BpModal.prototype.populateRecipients = function () {
        ...
        this.bpProvider.getItems(route + '?scope=friends&user=' + this.login_data.user_id + '&per_page=99', this.login_data, 1).then(function (items) {
            console.log(items);
    ...
    BpModal.prototype.submitForm = function () {
        ...
        if (!this.activity && !this.uploadedImage) {
            this.translate.get('Please enter some content.').subscribe(function (text) {
                _this.presentToast(text);
            });
            return;
        }
        ...
        if (this.uploadedImage) {
            this.bpProvider.postWithImage(this.login_data, this.activity, this.uploadedImage, this.groupId)
                .then(function (ret) {
                console.log(ret);
                _this.translate.get('Update posted!').subscribe(function (text) {
                    _this.presentToast(text);
                });
            ...
            this.bpProvider.sendMessage(this.recipients, this.login_data, this.activity.subject, this.activity.content, threadId).then(function (ret) {
                console.log(ret);
                if (ret) {
                    _this.translate.get('Message sent.').subscribe(function (text) {
                        _this.presentToast(text);
                    });
            ...
            this.bpProvider.postTextOnly(this.login_data, this.activity, this.groupId)
                ...
                console.log(ret);
                if (_this.isReply) {
                    _this.translate.get('Comment posted!').subscribe(function (text) {
                        _this.presentToast(text);
                    });
    ...
    BpModal.prototype.handleErr = function (e) {
